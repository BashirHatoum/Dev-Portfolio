    ...
    <div class="form-container default-margin mt-m">
        {#if isEmailSent}
            <div class="spinner-container">
                <h3>Thank you for getting in touch with me. 
                    I'll usually reply within 48 hours</h3>
            </div>
            {:else if isLoading}
                <div class="spinner-container">
            ...
            {:else if showErrorMessage}
                <h3>
                    We seem to have trouble with our server at the moment.
                    Please send me an email directly to 
                    <a class="link" href="bashirhatoum1@gmail.com">
                    bashirhatoum1@gmail.com  
                    </a>
                </h3>
            {:else}
            <form>
